        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicGarageId = table.Column<int>(type: "int", nullable: true),
                    IsUnderground = table.Column<bool>(type: "bit", nullable: true),
                    GarageLevel = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingPlaces_PublicGarage_PublicGarageId",
                        column: x => x.PublicGarageId,
                        principalTable: "PublicGarage",
                        principalColumn: "Id");
                    table.ForeignKey(
