...
namespace ParkEasyNBP.Infrastructure.SqlServer.Migrations
{
    ...
    [Migration("20240624135940_add-oneoffcards")]
    partial class addoneoffcards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkEasyNBP.Domain.Models.Zone", b =>
                {
                    ...
                    b.Property<int?>("OneOffCardId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("OneOffCardId");
            ...
            modelBuilder.Entity("ParkEasyNBP.Domain.Models.Zone", b =>
                {
                    b.HasOne("ParkEasyNBP.Domain.Models.OneOffCard", null)
                        .WithMany("Zones")
                        .HasForeignKey("OneOffCardId");
                });
